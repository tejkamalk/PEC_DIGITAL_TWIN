...
/****** Object:  Trigger [dbo].[st_pec_eniscope_4_parse]    Script Date: 8/23/2022 6:34:04 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE trigger [dbo].[st_pec_eniscope_4_parse] on [dbo].[st_pec_eniscope_4]
FOR INSERT
AS
DECLARE
    @message_id bigint,
...
ALTER TABLE [dbo].[st_pec_eniscope_4] ENABLE TRIGGER [st_pec_eniscope_4_parse]
GO
