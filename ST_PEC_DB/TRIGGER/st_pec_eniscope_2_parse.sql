...
/****** Object:  Trigger [dbo].[st_pec_eniscope_2_parse]    Script Date: 8/23/2022 6:34:04 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE trigger [dbo].[st_pec_eniscope_2_parse] on [dbo].[st_pec_eniscope_2]
FOR INSERT
AS
DECLARE
    @message_id bigint,
...
BEGIN
  ...
  parsed_data AS (SELECT message_ref_no,
   ...
   last_moment_energy_data AS (SELECT device_uid,
	...
	INSERT INTO stidata.dbo.st_pec_eniscope_2_meter_data (
	                                                         eniscope_uid_ref,
			                                                 device_uid,
			                                                 device_meter_id,
                                                             Record_time,
...
ALTER TABLE [dbo].[st_pec_eniscope_2] ENABLE TRIGGER [st_pec_eniscope_2_parse]
GO
