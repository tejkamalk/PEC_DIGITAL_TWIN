...
/****** Object:  Trigger [dbo].[st_pec_eniscope_8_parse]    Script Date: 8/23/2022 6:37:06 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE trigger [dbo].[st_pec_eniscope_8_parse] on [dbo].[ST_PEC_ENISCOPE_8]
FOR INSERT
AS
DECLARE
    @message_id bigint,
...
BEGIN
    ...
    WITH togo AS (SELECT @message_id message_ref_no,
         ...
         fina AS (SELECT message_ref_no,
                    ...
                    FROM togo)
	INSERT INTO stidata.dbo.st_pec_eniscope_8_meter_data (
	                                                         eniscope_uid_ref,
			                                                 device_uid,
			                                                 device_meter_id,
                                                             Record_time,
...
ALTER TABLE [dbo].[ST_PEC_ENISCOPE_8] ENABLE TRIGGER [st_pec_eniscope_8_parse]
GO
