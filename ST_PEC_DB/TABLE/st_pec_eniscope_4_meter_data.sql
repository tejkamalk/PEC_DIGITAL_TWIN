...
/****** Object:  Table [dbo].[st_pec_eniscope_4_meter_data]    Script Date: 22/8/2022 4:16:13 pm ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[st_pec_eniscope_4_meter_data](
	[uid] [bigint] NULL,
...
ALTER TABLE [dbo].[st_pec_eniscope_4_meter_data] ADD  DEFAULT (NEXT VALUE FOR [st_pec_eniscope_4_meter_data_seq]) FOR [uid]
GO

ALTER TABLE [dbo].[st_pec_eniscope_4_meter_data] ADD  DEFAULT (getdate()) FOR [update_datetime]
GO

ALTER TABLE [dbo].[st_pec_eniscope_4_meter_data] ADD  DEFAULT (user_name()) FOR [update_id]
GO
